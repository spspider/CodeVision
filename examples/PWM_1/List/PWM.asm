...
_0x4A:
	...
	.DB  0x4,0x0
_0x0:
	.DB  0x23,0x64,0x31,0x3D,0x25,0x64,0x23,0x64
	.DB  0x32,0x3D,0x25,0x64,0x23,0x64,0x33,0x3D
...
; 0000 002C 
; 0000 002D Timer_1++;
	LDI  R26,LOW(_Timer_1)
	LDI  R27,HIGH(_Timer_1)
	RCALL SUBOPT_0x1
...
; 0000 005F Timer1=0;
	...
	STS  _Timer1,R30
	STS  _Timer1+1,R31
; 0000 0060 if ((bit1>=TOL)&&(bit1>bit0)){// если все (25) битов были положительные, то добавляем 1
	RCALL SUBOPT_0xB
	RCALL SUBOPT_0xC
	CP   R26,R30
	CPC  R27,R31
...
; 0000 0063 bit10++;
	...
	LDI  R27,HIGH(_bit10)
	RCALL SUBOPT_0x1
; 0000 0064 d=d<<1; //сдвигаем переменную для битов
	LSL  R4
	ROL  R5
; 0000 0065 d|=1;//добавляем в конец строки положительный бит
	LDI  R30,LOW(1)
	OR   R4,R30
; 0000 0066 putchar('1');
	LDI  R30,LOW(49)
...
_0x30:
	RJMP _0x2F
_0x31:
; 0000 0069 //если все (25) битов были 0, то добавляем 0
...
; 0000 006C bit10=0;
	RCALL SUBOPT_0x4
	RCALL SUBOPT_0x12
; 0000 006D d=d<<1; //сдвигаем переменную для битов
	LSL  R4
	ROL  R5
; 0000 006E d&=~1;//добавляем в конец строки нулевой бит
	LDI  R30,LOW(254)
	AND  R4,R30
; 0000 006F putchar('0');
	LDI  R30,LOW(48)
...
_0x2F:
	LDI  R26,LOW(_shiftd)
	LDI  R27,HIGH(_shiftd)
	RCALL SUBOPT_0x1
; 0000 0072 ////////////////////////////
; 0000 0073 if ((bit01>5)||(bit10>5)){d=d1=d2=d3=shiftd=0;bit10=bit01=0;TCCR2&=~0x01;putchar('n');};//если принято 4-е нуля подряд то таймер останавливается.
	LDS  R26,_bit01
	LDS  R27,_bit01+1
	SBIW R26,6
	BRSH _0x33
