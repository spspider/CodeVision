...
_0x0:
	.DB  0x54,0x31,0x3A,0x25,0x2E,0x31,0x66,0x0
_0x2020003:
	.DB  0x80,0xC0
...
;char lcd_buffer[20],Timer_1;
;float set_temp1=99.9;
...
; 0000 0041 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
...
; 0000 0053 // Clock value: 7.813 kHz
; 0000 0054 TCCR0=(1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x33,R30
...
; 0000 0079 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 007A 
...
; 0000 008F ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0090 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
;if (Timer_1==1){
	...
	BRNE _0xA
;
;//set_temp1=read_adc(0)/4.00;
;set_temp1=10.10;
	__GETD1N 0x4121999A
	STS  _set_temp1,R30
	STS  _set_temp1+1,R31
	STS  _set_temp1+2,R22
	STS  _set_temp1+3,R23
;//sprintf(Temp_str, "T:%.1f", Temp);
;//lcd_init(16); /* инициализация на 16 символов */
;
;sprintf(lcd_buffer,"T1:%.1f",set_temp1);
	...
	RCALL SUBOPT_0x0
	LDS  R30,_set_temp1
	LDS  R31,_set_temp1+1
	LDS  R22,_set_temp1+2
	LDS  R23,_set_temp1+3
	RCALL __PUTPARD1
	LDI  R24,4
	RCALL _sprintf
	ADIW R28,8
