...
Timer_1++;
if (Timer_1==20){Timer_1=0;Timer_2++;} //скорость обновления PWM модулирования, значение меняется с частотой

if (Timer_1<sig1[0]){U1=1;}else{U1=6;} // sig1 + задержка драйвер для лампы 0 - значение 1й переменной
...
//PORTC=0b00011110;
DDRD=0x00;
TCCR0=0x01; // Clock value: 1000,000 kHz
TCNT0=0x00;
