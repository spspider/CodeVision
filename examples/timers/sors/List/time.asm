...
; 0000 0067        if (num==30)                 //если 30 сек. "зажигаем" ПОРТ В.0
	LDI  R30,LOW(30)
	LDI  R31,HIGH(30)
	CP   R30,R4
	CPC  R31,R5
...
; 0000 0068        PORTB.0=1;
	SBI  0x18,0
; 0000 0069 
; 0000 006A        if (num==100)               // если num = 100 сек. зануляем num и тушим ПОРТ В.0
_0x6:
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CP   R30,R4
...
; 0000 006D         PORTB.0=0;
	CBI  0x18,0
; 0000 006E        }
; 0000 006F        // выводим значение переменной на экран
