...
if (Timer1==FreqT){
Timer1=0;
if ((bit1>=TOL)&&(bit1>bit0)){// если все (25) битов были положительные, то добавляем 1
bit1=bit0=0;
bit01=0;
bit10++;
...
//если все (25) битов были 0, то добавляем 0
bit0=bit1=0;
bit01++;
bit10=0;
d=d<<1; //сдвигаем переменную для битов
...
shiftd++;
////////////////////////////
if ((bit01>5)||(bit10>5)){d=d1=d2=d3=shiftd=0;bit10=bit01=0;TCCR2&=~0x01;putchar('n');};//если принято 4-е нуля подряд то таймер останавливается.
